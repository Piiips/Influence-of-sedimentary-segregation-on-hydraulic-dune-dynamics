"""
================================================================================
Realistic_axes_model.py
Duna bidispersa — CORRIDA ÚNICA con UNA pendiente (Ejes a escala realista 1:1)
Concentración ÚNICA: φ_s = 0.7
================================================================================
Basado en `Single_slope_model.py`. La diferencia principal es que los gráficos
y visualizaciones resultantes (video, estado final y diagrama de abanico) están
estrictamente a escala (aspect ratio 1:1, misma distancia física/numérica en
píxeles entre los ejes X y Z).
...
en la sección 1.11 para conservar corridas previas):
  · Video               Realistic_axes_model_phi070.mp4
  · Estado final (PNG)  Realistic_axes_model_phi070.png
  · Diagrama de abanico Realistic_axes_model_fan_phi070.png
  · Snapshots (.npz)    Realistic_axes_model_snapshots_phi070.npz
...
t_max        = 3600.0 # [s] tiempo físico total simulado
...
def run_simulation():
    ...
    print(f"{pfx} ═══ INICIO (EJES A ESCALA REALISTA 1:1) ═══  R=d_l/d_s={R:.2f}  H={H_d*1e3:.1f}mm "
...
if __name__ == "__main__":
    print("══════════════════════════════════════════════════════════════")
    print(f"  Realistic_axes_model — φ_s = {PHI_S:.2f}, i = {i_slope:.5f}")
    ...
    print("  Adv.+segregación+difusión (Trewhela 2021) — Ejes a escala 1:1")
    print("══════════════════════════════════════════════════════════════", flush=True)
