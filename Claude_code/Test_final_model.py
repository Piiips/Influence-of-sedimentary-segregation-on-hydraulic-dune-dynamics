...
alpha_lee = 20.25    # [°] ángulo de reposo del sotavento (lee).  Fija la pendiente máxima
...
demo_speedup = 5.0     # [-] factor de aceleración SOLO para visualizar la laminación.
...
t_max        = 4800 #2400.0   # [s] tiempo físico total simulado
